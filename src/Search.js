      ...
      <main className="container">
        <form onSubmit={onSubmitHandler} action={url}>
          ...
          <div className="input-group">
            <input type="search" className="form-control form-control-lg" placeholder="Search a GitHub user" aria-label="GitHub username" aria-describedby="GitHubUsername" value={username} onChange={onChangeHandler} autoFocus={true} required />
