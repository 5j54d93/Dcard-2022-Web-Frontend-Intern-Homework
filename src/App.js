        ...
        <div class="container">
          <form onSubmit={this.handleSubmit} action={this.state.url}>
            ...
            <div class="input-group">
              <input type="search" class="form-control form-control-lg" style={{ color: 'rgb(195,212,225)', background: 'rgb(4,88,138)', border: 'rgb(4,88,138)' }} placeholder="Search for GitHub user" aria-label="GitHub username" aria-describedby="GitHubUsername" value={this.state.value} onChange={this.handleChange} autofocus='true' required />
