...
export default memo(function IconGroup(props) {
  return (
    <>
      ...
      <span className='me-3'>{props.starsCount}</span>
      <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' className='forkIcon bi bi-diagram-2-fill' viewBox='0 0 16 16'>
      ...
      <span className='me-3'>{props.forksCount}</span>
      ...
      <span className='me-auto'>{props.language}</span>
    </>
  );
})
